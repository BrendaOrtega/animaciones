...
import { RemixServer, Meta, Links, Outlet, ScrollRestoration, Scripts, Form, redirect, useLoaderData, json, Link, useFetcher } from "@remix-run/react";
import * as isbotModule from "isbot";
import { renderToPipeableStream } from "react-dom/server";
import Stripe from "stripe";
import { PrismaClient } from "@prisma/client";
import { twMerge } from "tailwind-merge";
import { useEffect, Children, useRef, useState, createContext, useContext } from "react";
import { useAnimate, stagger, motion, useAnimationControls, useInView, AnimatePresence, useScroll, useMotionValueEvent, useMotionValue, useVelocity, useSpring, useTransform, useAnimationFrame, useMotionTemplate } from "framer-motion";
...
import { FaLinkedin, FaGithub, FaYoutube, FaSquareXTwitter, FaPlay, FaGooglePlay } from "react-icons/fa6";
import { BsMenuButtonWide } from "react-icons/bs";
import { MdOutlineRadioButtonChecked, MdOutlineRadioButtonUnchecked, MdMenuOpen } from "react-icons/md";
  ...
  switch (event.type) {
    ...
    case "checkout.session.completed":
      ...
      const user = await getOrCreateUser({
        username: session.customer_email || ((_a = session.customer_details) == null ? void 0 : _a.email),
        email: session.customer_email || ((_b = session.customer_details) == null ? void 0 : _b.email),
      ...
      await db.user.update({
        ...
        data: {
          courses: {
            push: [.../* @__PURE__ */ new Set([...user.courses, (_d = session.metadata) == null ? void 0 : _d.courseSlug])]
          }
        }
      });
      break;
...
function Flipper({
  ...
  const generalClass = "text-white text-8xl items-center overflow-hidden w-64 md:w-80 h-56 justify-center absolute z-30 flex rounded-xl";
  return /* @__PURE__ */ jsxs(
    "article",
    {
      style: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(motion.div, { className: cn(generalClass, "z-10"), children: nextItem }),
        /* @__PURE__ */ jsx(motion.div, { animate: controls_3, className: cn(generalClass, "relative"), children: trickItem }),
        /* @__PURE__ */ jsx(
          "hr",
          {
            style: {
...
const Hero = ({ children }) => {
  return /* @__PURE__ */ jsx("section", { className: "bg-none md:bg-magic flex flex-wrap md:flex-nowrap  bg-contain bg-no-repeat bg-right pt-12 md:pt-[120px] min-h-[90vh] lg:min-h-[95vh]  ", children: /* @__PURE__ */ jsxs("div", { className: "w-full px-6 pt-0 md:px-0 lg:max-w-7xl mx-auto flex flex-col items-center ", children: [
    /* @__PURE__ */ jsx(Tools, {}),
    /* @__PURE__ */ jsxs("div", { className: "w-full lg:w-[70%] mx-auto -mt-8 md:mt-12 ", children: [
      /* @__PURE__ */ jsx(TextGenerateEffect, { words }),
      /* @__PURE__ */ jsx("p", { className: "text-iron dark:text-metal text-center text-lg lg:text-2xl font-light dark:font-extralight mt-3 mb-12", children: "Construye 12 componentes animados para tus proyectos web" }),
...
const Animations = () => {
  return /* @__PURE__ */ jsx(ScrollReveal, { children: /* @__PURE__ */ jsxs("section", { className: "my-[80px] lg:my-[120px]", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "text-iron dark:text-metal font-light text-lg md:text-xl lg:text-2xl  text-center mt-4", children: "A lo largo de 12 unidades y más de 20 lecciones, construirás" }),
...
const Card = ({
  ...
  return /* @__PURE__ */ jsxs("section", { className: "col-span-1 group", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        className: twMerge(
...
const ToggleButton = () => {
  ...
  return /* @__PURE__ */ jsx(
    Switch,
    {
      ...
      children: /* @__PURE__ */ jsx("span", { className: "size-4 h-6 w-6 dark:bg-[url('/moon.svg')] translate-x-1 rounded-full bg-[url('/sun.svg')] bg-cover  bg-white transition group-data-[checked]:translate-x-6" })
    }
  );
};
...
const Question = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border-lightgray dark:border-lightGray/20   border-[1px] rounded-2xl", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
  ...
  return /* @__PURE__ */ jsxs(Tab.Group, { children: [
    /* @__PURE__ */ jsxs(Tab.List, { className: "flex gap-0 md:gap-10 justify-between md:justify-center w-full md:w-[560px] mx-auto", children: [
      ...
      /* @__PURE__ */ jsx(Tab, { className: "border focus:outline-none data-[selected]:outline-fish data-[selected]:border-fish  data-[hover]:bg-transparent  dark:data-[hover]:bg-[#131316] data-[focus]:outline-1 data-[focus]:outline-white   bg-[#ffffff] dark:bg-transparent border-lightGray dark:border-lightGray/20 w-[48%] md:w-[260px] h-[160px] rounded-3xl flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-iron font-light dark:text-metal text-sm mt-2", children: "Full course + Player oficial" })
      ] }) })
    ] }),
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-base font-light text-iron dark:text-metal  flex flex-col gap-4 mt-10", children: [
              /* @__PURE__ */ jsx("p", { children: "📹 12 unidades con tutoriales en video (1 por componente)" }),
              /* @__PURE__ */ jsx("p", { children: "💪🏻 Learnings y ejercicios por lección" }),
              /* @__PURE__ */ jsx("p", { children: "📚 Recursos extra " }),
              /* @__PURE__ */ jsx("p", { children: "💀 Acceso de por vida" }),
              /* @__PURE__ */ jsx("p", { children: "🚀 Actualizaciones futuras del curso" }),
              /* @__PURE__ */ jsx("p", { children: "🫶🏻 Acceso a la comunidad de Disscord" })
            ] }),
            /* @__PURE__ */ jsxs(PrimaryButton, { className: " mt-12 w-full ", children: [
              "Comprar curso ",
              /* @__PURE__ */ jsx("img", { src: "/cursor.svg" })
            ] })
          ]
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-base font-light text-iron dark:text-metal flex flex-col gap-4 mt-10", children: [
                /* @__PURE__ */ jsxs("p", { children: [
                  "📹",
                  " ",
                  /* @__PURE__ */ jsx("strong", { className: "font-semibold text-iron dark:text-white/60", children: "12 unidades" }),
                  " ",
...
const Marquee = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("article", { className: cn("flex justify-center items-center", className), children: /* @__PURE__ */ jsx("div", { className: "h-16 md:h-20 flex items-center text-gray-100  text-2xl lg:text-3xl font-extrabold overflow-hidden", children: /* @__PURE__ */ jsxs(motion.div, { style: { x }, className: "whitespace-nowrap", ref, children: [
    children,
    " ",
    children
  ] }) }) }) });
...
const FloatingDockDesktop = ({
  ...
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: items.map((item) => /* @__PURE__ */ jsx(IconContainer, { mouseX, ...item }, item.title))
    }
  ) });
};
  ...
  return /* @__PURE__ */ jsx("a", { href, target: "_blank", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(motion.div, { className: "flex items-center justify-center ", children: icon })
      ]
    }
  ) });
}
  ...
  return /* @__PURE__ */ jsx(ScrollReveal, { children: /* @__PURE__ */ jsx(CardContainer, { className: "inter-var ", children: /* @__PURE__ */ jsxs(
    CardBody,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(CardItem, { as: "p", translateZ: "100", children: /* @__PURE__ */ jsxs("p", { className: "text-base md:text-lg text-iron dark:text-metal font-light mt-8 md:mt-12 xl:mt-16", children: [
          '"',
          comment,
          '"'
        ] }) }),
...
function Route$3({ children }) {
  return /* @__PURE__ */ jsxs("main", { id: "main", className: "  bg-white dark:bg-dark overflow-hidden", children: [
    /* @__PURE__ */ jsx("nav", { className: "fixed h-16  bg-white/40 dark:bg-dark/40 backdrop-blur-md z-[100] w-full  px-6 md:px-[6%] lg:px-0 ", children: /* @__PURE__ */ jsxs("div", { className: "xl:max-w-7xl justify-between items-center h-16 mx-auto flex", children: [
      /* @__PURE__ */ jsx("a", { children: /* @__PURE__ */ jsx("img", { className: "h-10", src: "/Logo.png", alt: "logo" }) }),
      /* @__PURE__ */ jsx(ToggleButton, {})
    ] }) }),
    /* @__PURE__ */ jsx(Hero, { children: /* @__PURE__ */ jsx(Form, { method: "POST", children: /* @__PURE__ */ jsxs(
      PrimaryButton,
      {
        name: "intent",
        value: "checkout",
  ...
  const jsx2 = /* @__PURE__ */ jsxs("article", { className: cn("relative ", className), children: [
    ...
    /* @__PURE__ */ jsxs(
      motion.section,
      {
        ...
        children: [
          header ? header : /* @__PURE__ */ jsxs("header", { className: "flex items-start justify-between mb-6", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "fot-bold text-2xl", children: title }),
...
const loader$2 = async ({ request }) => {
  ...
  return {
    user,
    isPurchased,
    video: !isPurchased && !video2.isPublic ? { ...video2, storageLink: "" } : video2,
    videos,
    moduleNames,
    searchParams: {
...
function Route$2() {
  const { isPurchased, video: video2, videos, searchParams, moduleNames } = useLoaderData();
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("article", { className: "bg-slate-950 relative overflow-x-hidden", children: [
      /* @__PURE__ */ jsx(
        VideoPlayer,
        {
    ...
    !isPurchased && !video2.isPublic && /* @__PURE__ */ jsxs(
      Drawer,
      {
        ...
        isOpen: true,
        children: [
          /* @__PURE__ */ jsxs("p", { className: "text-2xl text-center pt-20 pb-8", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-3xl text-center", children: [
      ...
      MenuListContainer,
      {
        ...
        children: moduleNames.map((moduleName, index) => {
          return /* @__PURE__ */ jsxs("div", { children: [
            ...
            videos.filter((vid) => vid.moduleName === moduleName).map((v) => /* @__PURE__ */ jsx(
              ListItem,
              {
                isLocked: !v.isPublic,
  ...
  return /* @__PURE__ */ jsxs(
    Link,
    {
      ...
      className: cn(
        ...
        {
          "bg-gray-800 my-1 hover:text-white text-white hover:bg-gray-800": isCurrent,
      ...
      children: [
        /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: isCurrent ? /* @__PURE__ */ jsx(FaPlay, {}) : isCompleted ? /* @__PURE__ */ jsx(MdOutlineRadioButtonChecked, {}) : /* @__PURE__ */ jsx(MdOutlineRadioButtonUnchecked, {})
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "capitalize text-sm pl-8", children: title }),
        isLocked ? /* @__PURE__ */ jsx("span", { className: "ml-auto pr-8", children: /* @__PURE__ */ jsx(IoMdLock, {}) }) : /* @__PURE__ */ jsxs("div", { className: "text-xs pl-auto ml-auto pr-8", children: [
          duration,
          "m"
        ] })
      ]
...
const ModuleHeader = ({
  ...
  return /* @__PURE__ */ jsxs("header", { className: "text-indigo-600 rounded-lg pl-9 py-3 bg-gray-800 flex items-center gap-4 mb-2", children: [
    /* @__PURE__ */ jsx("span", { className: cn("text-4xl", isCompleted && "text-green-500"), children: isCompleted ? /* @__PURE__ */ jsx(MdOutlineRadioButtonChecked, {}) : /* @__PURE__ */ jsx(MdOutlineRadioButtonUnchecked, {}) }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("p", { className: "font-sans capitalize font-extrabold text-white", children: subtitle }),
      /* @__PURE__ */ jsx(
        "h3",
        {
...
const VideoPlayer = ({
  ...
  return /* @__PURE__ */ jsxs("section", { className: "h-screen relative overflow-x-hidden", children: [
    /* @__PURE__ */ jsxs(AnimatePresence, { children: [
      !isPlaying && /* @__PURE__ */ jsx(
        motion.button,
        {
          ...
          children: /* @__PURE__ */ jsx("span", { className: "border flex items-center justify-center text-6xl text-white rounded-full bg-indigo-500 w-[120px] h-[90px]", children: /* @__PURE__ */ jsx(FaGooglePlay, {}) })
        },
        "play_button"
      ),
      nextVideo.index !== 0 && isEnding && /* @__PURE__ */ jsxs(
        motion.button,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-left text-lg", children: "Siguiente video" }),
              /* @__PURE__ */ jsx("h4", { className: "text-2xl md:w-[280px] md:truncate text-left", children: nextVideo.title })
            ] }),
            /* @__PURE__ */ jsx(
              "img",
              {
...
function Route$1() {
  return /* @__PURE__ */ jsxs("article", { className: "flex flex-col items-center h-screen justify-center gap-4 bg-slate-200", children: [
    ...
    /* @__PURE__ */ jsx(Link, { to: "/", children: /* @__PURE__ */ jsx(PrimaryButton, { children: "Volver al inicio" }) })
  ] });
}
...
function Route() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("article", { className: "bg-gradient-to-tr from-slate-950 to-indigo-950 h-screen py-20 px-8", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "my-8", children: modules.map((moduleTitle, i) => /* @__PURE__ */ jsx(
        Module,
        {
          index: i,
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
    Form,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("label", { className: "flex justify-between cursor-pointer my-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex mt-auto gap-4", children: [
          /* @__PURE__ */ jsx(
            PrimaryButton,
            {
...
const TextField = ({
  ...
  return /* @__PURE__ */ jsxs("label", { className: "flex flex-col gap-2 mb-4", children: [
...
const Module = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    isOpen && /* @__PURE__ */ jsxs("section", { className: "min-h-20 bg-slate-300 p-4 flex flex-col gap-2 group", children: [
      ...
      videos.map((video2, index) => /* @__PURE__ */ jsx(
        Video,
        {
          onClick: () => onVideoSelect == null ? void 0 : onVideoSelect(video2),
          video: video2
        },
        video2.id
      )),
...
const serverManifest = { "entry": { "module": "/assets/entry.client-CqCnjJUM.js", "imports": ["/assets/components-DPsHuwtA.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/root-D27Sitk2.js", "imports": ["/assets/components-DPsHuwtA.js"], "css": ["/assets/root-Df6IuwBY.css"] }, "routes/stripe.webhook": { "id": "routes/stripe.webhook", "parentId": "root", "path": "stripe/webhook", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/stripe.webhook-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-CClpmYXA.js", "imports": ["/assets/components-DPsHuwtA.js", "/assets/PrimaryButton-B7VohWgc.js", "/assets/iconBase-jmq2uqsB.js", "/assets/index-DHm8Hqmp.js", "/assets/index-DYnYCmOj.js"], "css": [] }, "routes/player": { "id": "routes/player", "parentId": "root", "path": "player", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/player-mdgSnBvt.js", "imports": ["/assets/components-DPsHuwtA.js", "/assets/iconBase-jmq2uqsB.js", "/assets/index-DYnYCmOj.js", "/assets/SimpleDrawer-BT4iV60b.js", "/assets/PrimaryButton-B7VohWgc.js"], "css": [] }, "routes/portal": { "id": "routes/portal", "parentId": "root", "path": "portal", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/portal-CDtY-IkD.js", "imports": ["/assets/components-DPsHuwtA.js", "/assets/PrimaryButton-B7VohWgc.js"], "css": [] }, "routes/admin": { "id": "routes/admin", "parentId": "root", "path": "admin", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/admin-CFpNnJVz.js", "imports": ["/assets/components-DPsHuwtA.js", "/assets/index-DHm8Hqmp.js", "/assets/PrimaryButton-B7VohWgc.js", "/assets/SimpleDrawer-BT4iV60b.js", "/assets/iconBase-jmq2uqsB.js"], "css": [] } }, "url": "/assets/manifest-4096d97c.js", "version": "4096d97c" };
